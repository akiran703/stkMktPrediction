...
#prediction
las_prediction = Las.predict(x_future)
...
#las_prediction=np.expand_dims(las_prediction,axis=1)
mse = np.mean((las_prediction - y_future)**2)
print('\nMean Sqaured Error = ',mse )


#r-square
correlation_matrix = np.corrcoef(las_prediction, y_future)
